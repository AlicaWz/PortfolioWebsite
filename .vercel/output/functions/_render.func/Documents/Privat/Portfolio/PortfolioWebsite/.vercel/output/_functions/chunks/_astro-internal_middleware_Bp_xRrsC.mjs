...
function getBreakpoints() {
  const cssContent = require$$0.readFileSync(
    require$$2.join(process.cwd(), "src/css/base/_mediaqueries.css"),
    "utf8"
  );
  const breakpoints = {};
...
const breakpoints = defineMiddleware((context, next) => {
  const cachedBreakpoints = BreakpointCache.get("breakpoints");
...
const onRequest$1 = sequence(breakpoints);
